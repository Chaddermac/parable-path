...
export default function ResultPage() {
  ...
  return <main>
    ...
    {result.syncStatus === "local-only" ? <p className="mb-8 rounded-xl border border-gold/30 bg-gold/10 p-4 text-sm leading-6 text-ink/65" role="status">Your result was computed locally and remains available on this device. Your anonymous research response will sync when storage reconnects; you do not need to retake the assessment.</p> : null}

...
export default async function AdminPage({ searchParams }: { searchParams: Promise<{ error?: string }> }) {
  ...
  return <main className="shell py-10 sm:py-16">
    <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end"><div><p className="eyebrow">Anonymous study overview</p><h1 className="mt-3 font-serif text-5xl sm:text-6xl"><span className="brand-name">ParablePath</span> admin</h1></div><div className="flex gap-3"><a className="button-primary" href="/api/admin/export">Export CSV</a><form action="/api/admin/logout" method="post"><button className="button-secondary" type="submit">Sign out</button></form></div></div>

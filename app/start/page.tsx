  ...
  return <main className="shell py-10 sm:py-16">
    <div className="mx-auto max-w-3xl">
      ...
      <div className="panel mt-10 p-6 sm:p-9">
        ...
        <div className="mt-7 rounded-xl bg-cream p-5 text-sm leading-6 text-ink/65"><strong className="text-ink">Please hold the result lightly.</strong> <span className="brand-name">ParablePath</span> is a spiritual reflection and formation tool, not a personality test, psychological or clinical diagnosis, prophecy, counseling, or crisis care. It cannot tell you who you are. Your responses are stored securely in Supabase, and your scores and written reflection are sent to OpenAI to generate the result. Names and email are not required.</div>

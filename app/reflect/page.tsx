...
export default function ReflectPage() {
  ...
  return <main className="shell py-12 sm:py-20"><div className="mx-auto max-w-3xl">
    ...
    <p className="mt-5 max-w-2xl leading-7 text-ink/60">
      There is no correct answer. A sentence or a few honest words are enough.
      Your reflection is stored with your assessment response in Supabase and
      sent to OpenAI to help generate your result. Your name and email address
      are not required.
    </p>
